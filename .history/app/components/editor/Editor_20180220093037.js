    ...
    saveDepthMap(){
        ...
        blockMap.forEach(k => {
            ...
            if(text.replace(/^\s+|\s+$/g, '') !== undefined){
                ...
                //     newDepthMap.set(depth, [text]);
                //     // this.setState({
                //     //     depthMap: newDepthMap.set(depth, [text])
                //     // });
                // }
                // else{
                //     newDepthMap.set(depth, newDepthMap.get(depth).concat([text]));
                //     // this.setState({
                //     //     depthMap: newDepthMap.set(depth, newDepthMap.get(depth).concat([text]))
                //     // });
                // }
                if(!depthMap.has(depth)){
                    ...
                    this.setState({
                        depthMap: depthMap.set(depth, depthMap.get(depth).concat([text]))
                    }, () => {
